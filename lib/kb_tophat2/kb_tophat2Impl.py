...
class kb_tophat2:
    ...
    GIT_COMMIT_HASH = "797cebb3ac9485265e33831a8eca540b54488b3e"
    ...
    def run_tophat2_app(self, ctx, params):
        ...
        :param params: instance of type "TopHatInput" (required params:
           ...
           sample_set) assembly_or_genome_ref: input reference Assembly or
           Genome object reference workspace_name: the name of the workspace
           it gets saved to alignment_object_name: output Alignment or
           AlignmentSet object name optional params: num_threads: number of
           ...
           Long, parameter "report_secondary_alignments" of String, parameter
           "no_coverage_search" of String, parameter "library_type" of
           String, parameter "preset_options" of String
